...
const mockUsers = [
  ...
  AppUser(
    ...
    campus: 'EurON Paulista',
    badgeCode: 'ALN-1002',
    learningTrack: 'Boas Praticas em Producao',
    className: 'Turma EURON A',
  ),
  AppUser(
    id: 'u-edu-003',
  ...
  AppUser(
    ...
    badgeCode: 'ALN-1004',
    learningTrack: 'Analises Laboratoriais',
...
const mockSuggestedStudents = [
  ...
  SuggestedStudent(
    ...
    engagement: 55,
    riskLevel: 'atencao',
    primaryNeed: 'Reforco em atividades praticas',
  ...
  SuggestedStudent(
    ...
    engagement: 58,
    riskLevel: 'atencao',
    primaryNeed: 'Acompanhamento de frequencia',
  ...
  SuggestedStudent(
    ...
    engagement: 44,
    riskLevel: 'critico',
    primaryNeed: 'Plano de recuperacao imediato',
...
const mockLessons = [
  ...
  LessonInfo(
    ...
    title: 'Fluxo esteril em sala limpa',
    dateLabel: 'Seg 10:00',
    format: 'Presencial',
    durationMinutes: 120,
  ),
  ...
  LessonInfo(
    ...
    title: 'Hipotese e desenho experimental',
    dateLabel: 'Sex 10:00',
    format: 'Online',
    durationMinutes: 90,
  ),
...
const mockForums = [
  ...
  ForumInfo(
    id: 'forum-02',
    disciplineId: 'disc-02',
    title: 'Duvidas de validacao asseptica',
    authorName: 'Joao Victor',
    replies: 8,
  ...
  ForumInfo(
    id: 'forum-07',
    disciplineId: 'disc-07',
    title: 'Caso clinico colaborativo',
...
const mockAlerts = [
  AlertItem(
    ...
    level: 'critico',
    title: 'Presenca e engajamento em queda',
    reason: 'Presenca abaixo de 60% e baixa atividade no Moodle.',
    recommendedAction: 'Contato em ate 24h e plano de recuperacao de faltas.',
  ),
  AlertItem(
    id: 'alert-02',
    studentName: 'Mariana Costa',
    level: 'atencao',
    title: 'Participacao online reduzida',
    reason: 'Participacao em foruns caiu nos ultimos 14 dias.',
    recommendedAction: 'Ativar missao curta e reforcar rotina de estudos.',
  ),
  AlertItem(
    id: 'alert-03',
    studentName: 'Pedro Henrique',
    level: 'atencao',
    title: 'Oscilacao de presenca',
  ...
  AlertItem(
    ...
    reason: 'Atividade pratica sem envio ha 3 dias.',
  ...
  AlertItem(
    ...
    recommendedAction: 'Sugerir dupla de estudo e missao colaborativa.',
  ),
  AlertItem(
    id: 'alert-06',
    studentName: 'João Pedro Lima',
    ...
    reason: 'Frequencia e entregas muito abaixo da turma.',
  ...
  AlertItem(
    ...
    reason: 'Boa frequencia e evolucao constante.',
  ...
  AlertItem(
    ...
    level: 'baixo',
    title: 'Evolucao positiva',
    reason: 'Subiu 8 pontos em engajamento no ultimo ciclo.',
  ...
  AlertItem(
    ...
    reason: 'Participacao constante em aulas e foruns.',
  ...
  AlertItem(
    ...
    reason: 'Nota da ultima atividade abaixo da media pessoal.',
    recommendedAction: 'Revisao guiada dos pontos de duvida.',
  ),
];
...
const mockRewards = [
  RewardItem(
    id: 'reward-01',
    title: 'Mentoria rapida com especialista',
  ...
  RewardItem(
    ...
    description: 'Janela extra para pratica assistida.',
    costPoints: 500,
    unlocked: true,
  ),
  RewardItem(
    ...
    description: 'Reconhecimento por alta frequencia mensal.',
    costPoints: 350,
    unlocked: true,
  ),
  RewardItem(
  ...
  RewardItem(
    ...
    description: 'Material de apoio para ciclos de revisao.',
    costPoints: 300,
    unlocked: true,
  ),
  RewardItem(
    ...
    description: 'Reconhecimento institucional da evolucao.',
    costPoints: 450,
    unlocked: true,
  ),
  RewardItem(
...
const mockMissions = [
  Mission(
    id: 'mission-01',
    title: 'Confirmar presenca na aula de hoje',
  ...
  Mission(
    ...
    description: 'Finalize o modulo de boas praticas laboratoriais.',
    points: 120,
    completed: false,
    dueLabel: 'Hoje',
  ),
  ...
  Mission(
    ...
    description: 'Compartilhe uma duvida tecnica com o grupo.',
    points: 55,
    completed: true,
    dueLabel: 'Concluida',
  ),
  Mission(
    ...
    description: 'Validar os pontos criticos da ultima aula pratica.',
    points: 70,
    completed: false,
    dueLabel: 'Amanha',
  ),
  ...
  Mission(
    ...
    description: 'Participar da sessao de duvidas com o educador.',
    points: 85,
    completed: false,
    dueLabel: 'Qui',
  ),
  Mission(
    ...
    description: 'Registrar conformidade no ambiente de pratica.',
    points: 65,
    completed: true,
    dueLabel: 'Concluida',
  ),
...
const mockMetrics = [
  ...
  DashboardMetric(
    id: 'metric-05',
    label: 'Participacao em forum',
    value: '71%',
    helper: 'Media por turma',
    status: 'attention',
    trend: '+0.9%',
  ),
  DashboardMetric(
    id: 'metric-06',
    label: 'Satisfacao de trilha',
    value: '4,6/5',
...
const mockCarePriorities = [
  CarePriority(
    studentName: 'João Pedro Lima',
    level: 'critico',
    reason: 'Risco de evasao por baixa frequencia e baixa entrega.',
    nextAction: 'Contato 1:1 hoje e plano de recuperacao com familia.',
  ),
  CarePriority(
    studentName: 'Rafael Gomes',
    level: 'critico',
    reason: 'Queda acentuada em presenca e engajamento.',
    nextAction: 'Acionar rede de apoio e tutor de referencia.',
  ),
  CarePriority(
    studentName: 'Mariana Costa',
    level: 'atencao',
    reason: 'Participacao em forum em queda progressiva.',
    nextAction: 'Definir meta semanal com check-ins curtos.',
  ),
  CarePriority(
    studentName: 'Pedro Henrique',
    level: 'atencao',
    reason: 'Duas faltas recentes em aulas sincronas.',
    nextAction: 'Ajustar plano de presenca e material de reposicao.',
  ),
  CarePriority(
    studentName: 'Gabriel Santos',
    level: 'atencao',
    reason: 'Entrega pendente e nota oscilante.',
    nextAction: 'Revisao guiada da atividade com prazo combinado.',
  ),
];

const mockActionSuggestions = [
  ActionSuggestion(
    title: 'Missao rapida de retomada',
    description:
        'Criar missao de 15 minutos para reengajar estudantes em atencao.',
    expectedImpact: 'Aumentar participacao em ate 8% no ciclo.',
  ),
  ActionSuggestion(
  ...
  ActionSuggestion(
    ...
    expectedImpact: 'Reduzir reincidencia de atraso em ate 20%.',
  ),
  ActionSuggestion(
    title: 'Plantao de duvidas tematico',
    description:
        'Abrir encontro curto focado no topico com maior erro da turma.',
    expectedImpact: 'Elevar nota media da proxima avaliacao.',
  ),
];
...
const mockGestaoEngagementDrops = [
  EngagementDrop(
    className: 'Turma EURON F',
    deltaLabel: '-6,2%',
    reason: 'Baixa adesao ao forum e faltas recorrentes.',
  ),
  EngagementDrop(
    className: 'Turma EURON B',
    deltaLabel: '-4,8%',
    reason: 'Oscilacao de presenca em aulas praticas.',
  ),
  EngagementDrop(
    className: 'Turma EURON E',
    deltaLabel: '-3,1%',
...
const mockTeachers = [
  TeacherInfo(
    ...
    disciplines: ['Bases Clinicas', 'Protocolos Assistenciais'],
  ),
  TeacherInfo(
    id: 'teacher-02',
    name: 'Ana Duarte',
    ...
    status: 'info',
    statusLabel: 'Estável',
    disciplines: ['Processos Assepticos', 'Regulatorio Global'],
  ),
  TeacherInfo(
    id: 'teacher-03',
    name: 'Thiago Mendes',
    ...
    disciplines: ['Auditoria de Qualidade', 'Gestao Lean'],
  ),
  TeacherInfo(
    id: 'teacher-04',
    name: 'Paulo Freitas',
    ...
    status: 'success',
    statusLabel: 'Destaque',
    disciplines: ['Cromatografia', 'Metodos Cientificos'],
  ),
  TeacherInfo(
    id: 'teacher-05',
    name: 'Fernanda Reis',
    ...
    status: 'success',
    statusLabel: 'Destaque',
    disciplines: ['Regulatorio Global'],
  ),
  TeacherInfo(
    id: 'teacher-06',
  ...
  TeacherInfo(
    ...
    status: 'info',
    statusLabel: 'Estável',
    disciplines: ['Metodos Cientificos', 'Dados em Saude'],
  ),
];
...
const mockForumMessages = [
  ...
  ForumMessage(
    ...
    authorRole: 'Educanda',
    message:
        'Perfeito, isso esclareceu a duvida da lista de exercicios. Obrigada!',
    timeLabel: 'ha 20min',
  ),
  ForumMessage(
    id: 'msg-04',
    ...
    authorRole: 'Educando',
    message:
        'Na validacao asseptica, qual a frequencia recomendada para o media '
  ...
  ForumMessage(
    ...
    message:
        'Boa pergunta. O guia recomenda no minimo duas simulacoes por semestre '
        'por turno de operacao. Anexei o checklist na proxima aula.',
    timeLabel: 'ha 1h30',
  ),
  ForumMessage(
    id: 'msg-06',
    ...
    message:
        ...
        'os pontos criticos que caem com mais frequencia.',
    timeLabel: 'ha 3h',
  ),
  ForumMessage(
    id: 'msg-07',
    ...
    authorRole: 'Educador',
    message:
        'Excelente iniciativa. Vou usar esse checklist como base na avaliacao.',
    timeLabel: 'ha 2h',
  ),
  ForumMessage(
    id: 'msg-08',
    ...
    authorRole: 'Educando',
    message:
        'Tenho duvida em identificar coeluicao em cromatogramas com picos muito '
        'proximos. Alguma dica de leitura?',
    timeLabel: 'ha 4h',
  ),
  ForumMessage(
    id: 'msg-09',
    ...
    message:
        ...
        'em duvida, ajuste a fase movel e repita a corrida.',
    timeLabel: 'ha 3h',
  ),
  ForumMessage(
    id: 'msg-10',
    ...
    authorRole: 'Educadora',
    message:
        'Abri o topico para consolidarmos a interpretacao das normas ICH Q7. '
...
SuggestedStudent? suggestedStudentById(String id) => _suggestedStudentsById[id];
...
List<ForumMessage> messagesForForum(ForumInfo forum) {
  ...
  return [
    ForumMessage(
      ...
      authorRole: 'Autor do topico',
      message:
          'Topico "${forum.title}" aberto para discussao da turma. '
          'Participe deixando duvidas e contribuicoes.',
